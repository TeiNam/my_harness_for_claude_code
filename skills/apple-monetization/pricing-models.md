...
|--------|-------------|----------|----------|------------|---------|-------------|
| Recurring revenue | PASS: | FAIL: | FAIL: | Partial | FAIL: | Partial |
| User-friendly | WARNING: | PASS: | PASS: | WARNING: | PASS: | WARNING: |
| Implementation complexity | High | Low | Medium | High | Low | Medium |
| Scalability | PASS: | FAIL: | PASS: | PASS: | FAIL: | PASS: |
| Indie-friendly | PASS: | PASS: | PASS: | WARNING: | FAIL: | WARNING: |
| Works with small audience | PASS: | PASS: | FAIL: | FAIL: | FAIL: | FAIL: |
