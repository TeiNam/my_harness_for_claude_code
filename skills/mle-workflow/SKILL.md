...
| `eval-harness` / `superpowers:verification-before-completion` | Turn offline metrics, slice checks, latency budgets, and rollback drills into repeatable gates |
