...
```swift
// FAIL: ObservedObject for view-owned
@ObservedObject var viewModel = MyViewModel()

// FAIL: State for complex objects
@State var viewModel = MyViewModel()

// FAIL: Multiple sources of truth
@State var name = ""
var expense: Expense
```
...
```swift
// PASS: StateObject for view-owned
@StateObject private var viewModel = MyViewModel()

// PASS: ObservedObject for passed
@ObservedObject var viewModel: MyViewModel

// PASS: Binding for child-parent connection
...
// PASS: Separate view components
struct ExpenseRow: View {
    let expense: Expense
    var body: some View { /* ... */ }
}

// PASS: Logic in ViewModel or computed property
...
```swift
// FAIL: Creating objects in body
var body: some View {
    let formatter = DateFormatter() // Created every render!
    Text(formatter.string(from: date))
}

// FAIL: Heavy computation without caching
var body: some View {
...
// PASS: Computed in ViewModel
var totalAmount: Double {
    viewModel.totalAmount
}

// PASS: Use @State for computed values
...
```swift
// PASS: Provide stable IDs
List(expenses, id: \.id) { expense in
    ExpenseRow(expense: expense)
}

// PASS: For dynamic lists
List {
...
// PASS: Sheet presentation
.sheet(isPresented: $showingSheet) {
    AddItemView()
}

// PASS: Alert presentation
...
```swift
// PASS: Weak self in escaping closures
func loadData() {
...
```swift
// PASS: Proper task lifecycle
.task {
    await viewModel.loadData()
}
// Automatically cancelled when view disappears

// PASS: Manual task management
