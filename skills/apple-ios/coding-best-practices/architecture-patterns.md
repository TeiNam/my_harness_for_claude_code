...
// PASS: ViewModel with business logic
class ExpenseViewModel: ObservableObject {
...
// PASS: Unowned for guaranteed non-nil
class ExpenseView {
...
```swift
// PASS: Testable with dependency injection
protocol DataStore {
    func save() throws
}
...
```swift
// PASS: Always validate user input
