...
### Feature 1: [Name]
- **Status**: PASS: Complete /  Partial / FAIL: Broken
...
|---------|--------|---------|--------|----------|
| [Feature 1] | PASS: | Good | None | High |
| [Feature 2] |  | Fair | [Issues] | Medium |
| [Feature 3] | PASS: | Poor | [Issues] | High |
...
### Strengths
- PASS: [What's good about current organization]
- PASS: [Another strength]

### Weaknesses
- FAIL: [What's problematic]
- FAIL: [Another issue]
...
|-----------|---------|---------|--------|--------|
| [Name] | [X.X.X] | [Purpose] | PASS: Updated / WARNING: Outdated | [Any issues] |
| [Name] | [X.X.X] | [Purpose] | PASS: Updated / WARNING: Outdated | [Any issues] |
...
## Strengths
- PASS: [UI/UX strength 1]
- PASS: [UI/UX strength 2]
