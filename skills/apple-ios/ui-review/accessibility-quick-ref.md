...
### Custom Controls
```swift
// FAIL: Bad - VoiceOver doesn't know it's tappable
...
```swift
// PASS: Good - Scales automatically
Text("Expense Title")
    .font(.headline)
...
```swift
// PASS: Good - Custom font that scales
Text("Title")
    .font(.custom("SF Pro Display", size: 17, relativeTo: .body))

// FAIL: Bad - Fixed custom font
Text("Title")
...
### Semantic Colors
```swift
// PASS: Good - Adapts to light/dark mode
Text("Title")
