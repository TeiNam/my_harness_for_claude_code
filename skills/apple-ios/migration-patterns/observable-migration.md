...
```swift
// PASS: Correct: use @Bindable for bindings to non-owned @Observable
struct SettingsView: View {
...
```swift
// FAIL: Using @Published with @Observable (redundant, causes issues)
@Observable
class Settings {
    @Published var name: String = ""  // Wrong: @Published is for ObservableObject
}

// PASS: Plain stored properties with @Observable
@Observable
class Settings {
    var name: String = ""
}
...
```swift
// FAIL: Using @ObservedObject with @Observable class
struct MyView: View {
...
// PASS: Plain var or @Bindable with @Observable class
struct MyView: View {
...
```swift
// FAIL: Using @StateObject with @Observable class
...
// PASS: Use @State with @Observable class
struct ParentView: View {
...
```swift
// FAIL: Using .environmentObject with @Observable class
ContentView()
    .environmentObject(settings)  // Wrong: .environmentObject is for ObservableObject

// PASS: Use .environment with @Observable class
ContentView()
    .environment(settings)
```

```swift
// FAIL: Forgetting @Bindable when creating bindings to @Environment observable
struct ProfileView: View {
