...
description: >-
  Analyze raw prompts, identify intent and gaps, match harness components
...
Analyze a draft prompt, critique it, match it to harness ecosystem components,
...
- User says "how should I use the harness for..."
...
Map intent + scope + tech stack (from Phase 0) to specific harness components.
...
A compact version for experienced harness users. Vary by intent type:
...
- "Optimize this prompt for the harness"
- "Rewrite this prompt so Claude Code uses the right commands"
- "帮我优化这个指令"
- "How should I prompt the harness for this task?"
