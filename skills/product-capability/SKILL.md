...
If useful, point to the next harness-native lane:
...
HANDOFF
- what should happen next and which harness lane should take it
```
...
- The resulting plan is reusable across Claude Code, Codex, Cursor, OpenCode, and harness 2.0 planning surfaces.
