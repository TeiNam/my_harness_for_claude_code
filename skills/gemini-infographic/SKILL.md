...
- **Footer CTA**: handwritten text reading "Follow [Name] [Tagline] for more helpful content | Repost "
...
Always include the handwritten text "Follow [Name] [Tagline] for more helpful content | Repost " at the bottom of the image, in the same hand-drawn marker style.
```
