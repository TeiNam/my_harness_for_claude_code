...
```swift
// FAIL: No container background — accented mode shows nothing
...
// PASS: Background marked as removable
...
```swift
// FAIL: Same complex layout at all distances
...
// PASS: Simplified layout when far away
