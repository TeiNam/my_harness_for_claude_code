...
Low Volume + Low Difficulty = PASS: Easy Wins
Low Volume + High Difficulty = FAIL: Skip
```
...
```
FAIL: BEFORE (duplicated words waste 23 characters):
...
PASS: AFTER (zero duplication, 5 new keywords gained):
