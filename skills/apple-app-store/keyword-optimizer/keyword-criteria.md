...
```
Seed: "timer"
├── pomodoro timer (Pop 35, Diff 42) PASS:
├── study timer (Pop 28, Diff 38) PASS:
├── focus timer (Pop 40, Diff 55) WARNING:
├── interval timer (Pop 32, Diff 35) PASS:
└── countdown timer (Pop 45, Diff 62) WARNING:
