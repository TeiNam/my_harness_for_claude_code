...
|---------------|-----|---------|-----------|--------|
| 2.1 Crashes | PASS: | | | |
| 2.1 Placeholder | PASS: | | | |
| 2.3 Metadata | PASS: | | | |
| 2.5.1 Private API | PASS: | | | |
| 3.1.1 IAP | PASS: | Sometimes | | |
| 3.1.2 Subscriptions | PASS: | Sometimes | | |
| 4.0 Design | PASS: | Sometimes | Sometimes | |
| 4.2 Minimum functionality | Sometimes | PASS: | PASS: | PASS: |
| 4.3 Spam | PASS: | PASS: | Sometimes | Sometimes |
| 5.1.1 Privacy | PASS: | | | |
| 5.1.2 Tracking | PASS: | | | |
| 5.2.1 Legal | PASS: | | | |
