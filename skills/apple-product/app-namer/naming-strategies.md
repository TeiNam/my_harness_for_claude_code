...
```
PASS: "Fantastical" (11)  → shows fully
PASS: "Halide" (6)        → shows fully
WARNING: "Carrot Weather"   → shows "Carrot Weat…" (the brand word still reads)
FAIL: "Productivity Pro"  → shows "Productivit…" (useless)
```
...
- FAIL: Another app's name or a trademark you don't own
- FAIL: Prices or pricing terms ("Free", "$2.99")
- FAIL: "for iPhone", "for iPad", "for Apple Watch", or platform names
- FAIL: "best", "#1", or unverifiable superlatives
- FAIL: Emoji or decorative special characters
- FAIL: Misleading terms (functionality the app doesn't have)
...
- PASS: "Brim" → `com.company.brim` (clean)
- WARNING: "Carrot Weather" → `com.company.carrotweather` (fine, just longer)
- FAIL: "My App!! 2.0" → forces an awkward sanitized identifier
