...
**When to Use**:
- PASS: Button taps (light)
- PASS: Toggle switches (light)
- PASS: Pull-to-refresh triggered (medium)
- PASS: Successful action (success pattern)
- PASS: Error occurred (error pattern)
- FAIL: Scrolling (no haptic)
- FAIL: Text input (no haptic)
- FAIL: Standard navigation (no haptic)
...
7. **Present to User**
   ...
   ```
   PASS: UI/UX Specifications generated!
