...
### FAIL: Don't Just List Competitors
```
...
### FAIL: Don't Ignore Indirect Competition
```
...
### FAIL: Don't Skip Pricing Analysis
```
...
1. PASS: List of 3-5 main competitors with details
2. PASS: Feature comparison matrix
3. PASS: Pricing comparison table
4. PASS: SWOT for each competitor
5. PASS: 3-5 differentiation opportunities identified
6. PASS: Positioning recommendation
7. PASS: Pricing strategy recommendation
