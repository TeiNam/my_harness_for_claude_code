...
|----------|--------|--------|
| Secure Storage | PASS:/WARNING:/FAIL: | X issues |
| Authentication | PASS:/WARNING:/FAIL: | X issues |
| Network Security | PASS:/WARNING:/FAIL: | X issues |
| Platform Security | PASS:/WARNING:/FAIL: | X issues |
