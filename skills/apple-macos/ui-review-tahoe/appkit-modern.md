...
```swift
// PASS: GOOD: Modern view controller
...
```swift
// PASS: GOOD: Use NSVisualEffectView for Liquid Glass
...
```swift
// PASS: GOOD: Window with transparency
...
```swift
// PASS: GOOD: Cell-based table view
...
```swift
// PASS: GOOD: Modern window controller
...
// PASS: GOOD: Validating menu items
...
// PASS: GOOD: Core Animation layers
...
```swift
// PASS: GOOD: Hosting SwiftUI in AppKit
...
// PASS: GOOD: Embedding AppKit in SwiftUI (see swiftui-macos.md)
```
