...
```swift
// PASS: GOOD: Accessibility labels
Button(action: save) {
...
// PASS: GOOD: Custom accessibility for complex views
...
```swift
// PASS: GOOD: Accessibility in AppKit
...
// PASS: GOOD: Setting accessibility programmatically
...
```swift
// PASS: GOOD: Adding traits
.accessibilityAddTraits(.isButton)
.accessibilityAddTraits(.isSelected)
.accessibilityAddTraits(.isHeader)
.accessibilityAddTraits(.startsMediaSession)

// PASS: GOOD: Removing default traits
.accessibilityRemoveTraits(.isImage)

// PASS: GOOD: Custom actions
...
```swift
// PASS: GOOD: Hide decorative elements from VoiceOver
Image(decorative: "background-pattern")
    .accessibilityHidden(true)

// PASS: GOOD: Skip navigation elements
Divider()
    .accessibilityHidden(true)
...
```swift
// PASS: GOOD: Keyboard shortcuts with VoiceOver announcements
Button("New Document") {
    createDocument()
}
...
// PASS: GOOD: Custom key equivalent in AppKit
...
```swift
// PASS: GOOD: Ensure proper tab order
...
```swift
// PASS: GOOD: Dynamic Type support
Text("Heading")
...
// PASS: GOOD: Custom font with Dynamic Type
Text("Custom")
    .font(.custom("MyFont", size: 17, relativeTo: .body))

// FAIL: BAD: Fixed font size
Text("Fixed")
    .font(.system(size: 14))  // Won't scale!

// PASS: GOOD: Fixed size when necessary, but allow scaling
Text("Fixed")
    .font(.system(size: 14))
...
```swift
// PASS: GOOD: Scale custom elements
@ScaledMetric private var iconSize: CGFloat = 24

Image(systemName: "star")
    .font(.system(size: iconSize))

// PASS: GOOD: Responsive layouts
...
```swift
// PASS: GOOD: Support increased contrast
...
// PASS: GOOD: Adjust border thickness
.border(
    .primary,
...
```swift
// PASS: GOOD: Respect reduce motion
...
// PASS: GOOD: Conditional animation
...
```swift
// PASS: GOOD: Provide alternative feedback for motion
if reduceMotion {
...
```swift
// PASS: GOOD: Debug accessibility in Xcode
...
```swift
// PASS: GOOD: Accessible list items
...
```swift
// PASS: GOOD: Accessible table cells
...
```swift
// PASS: GOOD: Custom button with full accessibility
...
```swift
// PASS: GOOD: Custom slider with accessibility
