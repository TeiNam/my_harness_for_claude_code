...
```swift
// PASS: GOOD: Clear dependencies and boundaries
...
```swift
// PASS: GOOD: Protocol defines contract
...
// FAIL: BAD: Multiple unrelated types in one file
...
```swift
// PASS: GOOD: Single place for dependency setup
@main
struct MyMacApp: App {
...
```swift
// PASS: GOOD: Custom view modifiers
...
```swift
// PASS: GOOD: Environment-based configuration
enum Environment {
    case development
    case staging
    case production
