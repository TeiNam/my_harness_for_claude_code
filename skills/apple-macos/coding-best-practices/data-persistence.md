...
// PASS: GOOD: Clean SwiftData model
@Model
final class Article {
...
// PASS: GOOD: In-memory container for testing
...
// PASS: GOOD: Dynamic query with init
struct ArticleListView: View {
...
// PASS: GOOD: Lazy loading with limits
...
// PASS: GOOD: Background context for heavy operations
...
// PASS: GOOD: Background operations
...
```swift
// PASS: GOOD: Property wrapper for UserDefaults
@propertyWrapper
...
// PASS: GOOD: Settings with UserDefaults
struct AppSettings {
...
// WARNING: Don't use UserDefaults for large data or complex objects
