...
```swift
// FAIL: WRONG: Defining your own AlarmAttributes type
...
// PASS: Import AlarmKit and use the framework-provided AlarmAttributes

// FAIL: WRONG: Using countdown presentations without a widget extension
// The countdown/paused UI simply will not appear
// PASS: Always add a widget extension with ActivityConfiguration(for: AlarmAttributes.self)
```
