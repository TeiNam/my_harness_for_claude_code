...
```swift
// FAIL: WRONG: Countdown presentation without a widget extension
...
// PASS: Implement the widget extension -- see live-activities.md

// FAIL: WRONG: Alert without a stop button
// AlarmPresentation.Alert always requires a stopButton
AlarmPresentation.Alert(title: "Alarm")
// PASS: Always provide a stopButton
