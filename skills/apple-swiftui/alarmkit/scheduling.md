...
```swift
// PASS: Correct property name
let state = AlarmManager.shared.authorizationState

// FAIL: WRONG: This property does NOT exist
...
```swift
// PASS: Timer with countdown -- no schedule
...
```swift
// FAIL: WRONG: Do not pass a schedule with a timer
