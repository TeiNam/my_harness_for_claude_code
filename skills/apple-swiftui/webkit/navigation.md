...
```swift
// FAIL: No feedback to user about loading state or errors
...
// PASS: Observe events for loading state and error handling
...
```swift
// FAIL: Returning NavigationPreferences() when you want to cancel
func decidePolicyFor(navigationAction: NavigationAction) -> NavigationPreferences? {
...
// PASS: Return nil to cancel, NavigationPreferences to allow
func decidePolicyFor(navigationAction: NavigationAction) -> NavigationPreferences? {
    if shouldBlock(navigationAction) {
