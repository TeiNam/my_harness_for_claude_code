...
```swift
// FAIL: Low-quality test — doesn't actually verify behavior
@Test("test items")
func testItems() {
    let vm = ViewModel()
    vm.loadItems()
...
```markdown
## Refactor Guard: WARNING: NEEDS TESTS
...
**Verdict**: PASS: PROCEED / WARNING: NEEDS TESTS /  STOP

### Coverage Summary
| Class | Public Methods | Tests | Coverage | Verdict |
|-------|---------------|-------|----------|---------|
| ItemManager | 9 | 12 | 89% | PASS: |
| ItemRepository | 5 | 2 | 40% | WARNING: |
