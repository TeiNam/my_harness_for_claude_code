...
```swift
// FAIL: Wrong: clear items on next-page error
...
// PASS: Right: keep existing items, show error for retry
func loadNextPage() async {
    do {
        let response = try await fetch()
