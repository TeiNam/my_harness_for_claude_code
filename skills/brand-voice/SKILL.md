...
5. If site copy matters, include the current harness landing page and repo/plugin framing.
...
If the user wants Affaan / harness voice and live sources are thin, start here unless newer source material overrides it:
