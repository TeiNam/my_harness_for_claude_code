...
```swift
// FAIL: Wrong -- Span cannot be captured
...
// PASS: Right -- use Span within the local scope only
...
```swift
// FAIL: Wrong -- span is invalidated after mutation
var array = [1, 2, 3]
let span = array.span
array.append(4)        // Invalidates span
// let x = span[0]     // Undefined behavior

// PASS: Right -- re-acquire span after mutation
var array = [1, 2, 3]
array.append(4)
