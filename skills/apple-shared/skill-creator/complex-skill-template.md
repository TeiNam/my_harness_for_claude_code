...
- PASS: Have extensive checklists (50+ items)
- PASS: Cover multiple distinct topics
- PASS: Include lots of code examples
- PASS: Need comprehensive reference material
- PASS: Would exceed 400-500 lines in a single file
...
```language
// FAIL: Bad - [Why it's bad]
[problematic code example]

// FAIL: Bad - [Another reason]
[another bad example]
```
...
```language
// PASS: Good - [Why it's good]
[good code example]

// PASS: Good - [Another good pattern]
...
```language
// FAIL: Violates guideline
[bad example]

// PASS: Follows guideline
[good example]
```
