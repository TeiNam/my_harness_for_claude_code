...
- PASS: Skill has a single, focused purpose
- PASS: Process can be described in <400 lines
- PASS: No extensive reference material needed
- PASS: Examples fit within the main file
- PASS: Checklist is concise

**Don't use when:**
- FAIL: Skill needs extensive checklists (>50 items)
- FAIL: Multiple distinct topics/categories
- FAIL: Lots of code examples
- FAIL: Complex reference material
