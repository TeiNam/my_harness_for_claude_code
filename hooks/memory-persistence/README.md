...
These lifecycle hook definitions document the harness's memory persistence contract for Claude Code manual installs.
...
- Bound context loaded at session start with `HARNESS_SESSION_START_MAX_CHARS`.
