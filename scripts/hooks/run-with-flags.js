#!/usr/bin/env node
/**
 * Executes a hook script only when enabled by harness hook profile flags.
 *
 * Usage:
...
async function main() {
  ...
  const result = spawnSync(process.execPath, [scriptPath], {
    ...
    env: {
      ...
      HARNESS_HOOK_ID: hookId,
      HARNESS_HOOK_INPUT_TRUNCATED: truncated ? '1' : '0',
      HARNESS_HOOK_INPUT_MAX_BYTES: String(MAX_STDIN)
    },
    cwd: process.cwd(),
    timeout: 30000
  });
