 ...
 *
 * This stays self-contained inside the harness. It does not call remote models
 * or install packages. The goal is to catch obviously generic UI drift and
 * keep frontend edits aligned with the harness's stronger design standards.
 */
