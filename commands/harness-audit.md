...
The script audits the current working directory by default and auto-detects whether the target is the harness repo itself or a consumer project using the harness.
...
6. Suggested harness skills to apply next.
