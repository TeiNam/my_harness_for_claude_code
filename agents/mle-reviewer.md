...
- Use `code-reviewer` (errors lens, `/review-pr --focus=errors`) when pipelines can appear green while skipping data, labels, eval slices, alerts, or artifact publication.
